...
// -----------------
const MaxPriceElement = document.querySelector('#MaxPrice');
const MinPriceElement = document.querySelector('#MinPrice');
...
function updateTotalPrice() {
    ...
    rows.forEach(row => {
        ...
        totalPrice += parseFloat(priceCell.textContent) * 12889,42 || 0; // Narxni qo'shish
    });

    // console.log(SelectPrice.textContent);
    ...
    // if(totalPrice > 50){}
    totalPriceElement.textContent = `Jami narxlar: ${totalPrice} mln`;
}
